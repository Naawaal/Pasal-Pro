...
void _transactionModelSerialize(
  ...
  writer.writeBool(offsets[5], object.isCredit);
  ...
  writer.writeDouble(offsets[10], object.profit);
  writer.writeLong(offsets[11], object.qtyPieces);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.id = id;
  object.isCredit = reader.readBool(offsets[5]);
  ...
  object.profit = reader.readDouble(offsets[10]);
  object.qtyPieces = reader.readLong(offsets[11]);
...
extension TransactionModelQueryWhereSort
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterWhere> anyIsCredit() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TransactionModelQueryWhere
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterWhereClause>
      isCreditNotEqualTo(bool isCredit) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, double, QQueryOperations> costPriceProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, int?, QQueryOperations> customerIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, bool, QQueryOperations> isCreditProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isCredit');
    });
  }

  QueryBuilder<TransactionModel, bool, QQueryOperations> isPaidProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, int?, QQueryOperations> productIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, double, QQueryOperations> profitProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'profit');
    });
  }

  QueryBuilder<TransactionModel, int, QQueryOperations> qtyPiecesProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, double, QQueryOperations> unitPriceProperty() {
    return QueryBuilder.apply(this, (query) {
