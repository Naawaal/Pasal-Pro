...
void _customerModelSerialize(
  ...
  writer.writeDateTime(offsets[4], object.lastTransactionAt);
  writer.writeString(offsets[5], object.name);
  writer.writeString(offsets[6], object.notes);
  writer.writeString(offsets[7], object.phone);
  writer.writeDouble(offsets[8], object.totalPurchases);
...
CustomerModel _customerModelDeserialize(
  ...
  object.lastTransactionAt = reader.readDateTimeOrNull(offsets[4]);
  object.name = reader.readString(offsets[5]);
  object.notes = reader.readStringOrNull(offsets[6]);
  object.phone = reader.readStringOrNull(offsets[7]);
  object.totalPurchases = reader.readDouble(offsets[8]);
...
extension CustomerModelQueryWhereSort
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerModelQueryWhere
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterWhereClause> nameGreaterThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterWhereClause> nameLessThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterWhereClause> nameBetween(
    String lowerName,
    String upperName, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterWhereClause> nameStartsWith(
      String NamePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'name',
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<CustomerModel, CustomerModel, QAfterWhereClause> phoneIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'phone',
        value: [null],
